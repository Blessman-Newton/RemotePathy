      ...
      <div className="layout-container flex h-full grow flex-col">
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e8eef3] px-10 py-3">
          ...
          <div className="flex flex-1 justify-end gap-8">
            ...
            <div
              className="relative flex cursor-pointer items-center overflow-hidden text-[#0e161b]"
              style={{ minWidth: "108px", height: "28px" }}
            >
              <span
                className="truncate overflow-ellipsis whitespace-nowrap text-left text-[#0e161b] text-sm font-medium leading-normal tracking-[0.015em]"
                title="New York, USA"
              >
                New York, USA
              </span>
        ...
        <main className="grow px-10 py-4">Content goes here...</main>
      </div>
    </div>
  );
};
